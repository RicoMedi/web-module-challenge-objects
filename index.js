...
*/
console.log('Task 1b:', createMenuItem('fish tacos', 9, 'Lunch'));
console.log('Task 1b:', createMenuItem('tortas', 10,'Lunch'));
console.log('Task 1b:', createMenuItem('Burrito', 12, 'Lunch'));
...
console.log('Task 5:', addReview(reviews,'Billy', 8,'Lame food'));
...
console.log('Task 6:', getReviewByIndex(reviews, 7));
